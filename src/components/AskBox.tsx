    ...
    <div className="space-y-2">
      ...
      {log.map((item, i) => (
        <div key={i} className="space-y-1.5">
          ...
          <div className="rounded-xl rounded-tl-sm bg-white px-3 py-2 text-sm text-gray-800 ring-1 ring-gray-200">
            <div className="mb-0.5 flex items-center gap-1.5 text-[10px] font-semibold text-gray-500">
              🐻 ガイド
              {item.mode === "demo" && (
      ...
      >
        ...
        <button
          ...
          className="h-10 rounded-full bg-amber-600 px-4 text-sm font-semibold text-white hover:bg-amber-700 disabled:opacity-60"
        >
          聞く
        </button>
      </form>
