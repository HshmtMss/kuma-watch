        ...
        items={[
          {
            ...
            a: (
              <>
                ...
                クマの鋭い嗅覚 (犬の数倍) に強い刺激を与えるほどではなく、効果は限定的。複数手段の中の補助として位置付けるのが現実的です。
              </>
            ),
            aText:
              "煙の匂いは火＝人間のサインとして機能する可能性はあるものの、煙草 1 本程度ではクマの鋭い嗅覚に強い刺激を与えるほどではなく、効果は限定的。複数手段の中の補助として位置付けてください。",
          },
          {
