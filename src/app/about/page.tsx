...
const FAQ = [
  ...
  {
    q: "どこの情報をもとに表示していますか？",
    a: "全国 47 都道府県の自治体公式サイト、警察、環境省など 70+ の公式ソース、Sharp9110、ニュース報道を毎日自動取り込みしています。詳細は /credits を参照。",
  },
  {
    q: "アプリはありますか？",
...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <h2>データソース</h2>
      <p>
        全国 70+ の自治体公式サイト・Sharp9110・環境省・ニュース報道・Open-Meteo・OpenStreetMap を毎日 2 回自動取り込み。各情報には出典自治体名と公式ページへのリンクを併記しています。詳細は{" "}
