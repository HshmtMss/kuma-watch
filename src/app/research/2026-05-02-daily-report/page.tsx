...
export default function ResearchPage() {
  return (
    <PageShell title={TITLE}>
      ...
      <p>秋田県</p>
      <p>147 - 154件</p>
      <p>全国最多、非常に高い活動状況 1</p>
      <p>2</p>
      <p>岩手県</p>
      <p>28件</p>
      <p>大規模山林火災による生息域攪乱の懸念 1</p>
      <p>3</p>
      <p>青森県</p>
      <p>28件</p>
      <p>1</p>
      ...
      <p>山形県</p>
      <p>27件</p>
      <p>4月30日に「クマ出没警報」を発令済 1</p>
      <p>5</p>
      <p>福島県</p>
      <p>27 - 31件</p>
      <p>警戒レベル「低」だが、市街地近郊での目撃増 1</p>
      <p>6</p>
      <p>富山県</p>
      <p>26件</p>
      <p>4月29日に人身被害が発生 1</p>
      ...
      <p>新潟県</p>
      <p>23 - 25件</p>
      <p>道路沿いや民家近傍での目撃が顕著 1</p>
      <p>8</p>
      <p>北海道</p>
      <p>22件</p>
      <p>ヒグマによる深刻な人身被害が発生 1</p>
      <p>9</p>
      <p>宮城県</p>
      <p>18件</p>
      <p>1</p>
      ...
      <p>14:00頃</p>
      <p>山口県萩市弥富下</p>
      <p>住宅の玄関を出た男性が20m先で遭遇</p>
      <p>体長約1.0m 21</p>
      <p>17:50頃</p>
      <p>山口市阿東篠目</p>
      <p>国道9号を横断する姿を運転手が目撃</p>
      <h3>体長約1.0m 21</h3>
      ...
      <p>* 新潟県阿賀町: 午後4時半前、東山の県道脇で体長約1メートルの熊が目撃された 3。民家からわずか160メートルの地点であり、津川警察署が現場を確認した 5。</p>
      <p>* 新潟県新発田市: 午後6時30分ごろ、小国谷地内の福禄寿石像付近で体長約50センチの子グマ1頭が目撃された 24。移動方向は東の山方向であったが、付近に母グマが潜伏している可能性が考慮され、注意喚起が行われた 24。</p>
      <p>* 福井県越前町・おおい町: 越前町道口では午後4時10分に幼獣が、おおい町山田では午後6時50分に成獣が目撃された 26。福井県内でも春先の活動が活発化しており、山間部の道路横断事案が目立っている。</p>
      <h3>北海道・東北地域のその他の目撃</h3>
      <p>* 北海道富良野市: 午前5時30分ごろ、国道38号線を走行中の車両の前に「丸々と大きな」ヒグマが出現した 27。</p>
      <p>* 北海道枝幸町: 午後2時ごろ、風烈布付近の道道で熊1頭が目撃された 28。</p>
      <p>* 岩手県大槌町: 同日、11日間にわたる大規模山林火災が「鎮圧」されたが、この1633ヘクタールに及ぶ焼失は、地域の生態系に甚大な影響を与え、生存した熊が新たな生息地を求めて周辺の居住区へ移動する二次的なリスクを孕んでいる 2。</p>
      <h2>生態学的背景：なぜ5月2日に事案が集中したのか</h2>
      <p>2026年5月2日に全国でこれほど多くの熊出没ニュースが重なった背景には、複数の生理学的・環境学的要因が存在する。</p>
      <h2>冬眠明けの生理的欲求とハイパーファジー</h2>
      ...
      <p>1. 誘引物の排除: 生ごみ、不要な農作物、放置された果実などは熊を人里に引き寄せる最大の要因である。本別町の事例のように玄関先まで熊が来る事態を防ぐには、物理的な誘引物の除去が不可欠である 17。</p>
      <p>2. 存在の周知: 入山時や山間部の通行時には、鈴やラジオ、笛などを用いて自身の存在を熊に知らせ、不意の遭遇を回避する。長野県上松町の森林作業員の事例のように、作業中や移動時の「音」の管理は生死を分ける 7。</p>
      <p>3. 緩衝地帯（ゾーニング）の整備: 住宅街周辺の藪を刈り払い、熊が身を隠せる場所をなくすことで、心理的な境界線を形成する 25。</p>
      <h3>結論と展望</h3>
