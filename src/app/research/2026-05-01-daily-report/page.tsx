...
export default function ResearchPage() {
  return (
    <PageShell title={TITLE}>
      ...
      <p>生態学的・社会的意図</p>
      <h3>国土交通省</h3>
      <p>河川敷の樹木伐採と見通しの確保。都道府県との連携強化 2。</p>
      <p>熊が移動経路として利用する「緑の回廊」を物理的に遮断し、市街地流入を阻止する 2。</p>
      <h3>林野庁</h3>
      <p>ブナ、ドングリ等の堅果類（実のり）の早期調査結果の共有 2。</p>
      <p>秋季の大量出没を予測し、早期の注意喚起や農作物防除体制の構築を図る 2。</p>
      <h3>環境省</h3>
      <p>クマの移動実態の可視化とリアルタイム情報の集約 1。</p>
      <p>出没地点のプロットから予測モデルを構築し、自治体間の広域連携を支援する 1。</p>
      <h3>警察庁</h3>
      <p>地域住民への注意喚起と、市街地侵入時の緊急対応体制の維持 2。</p>
      <p>人身被害発生時の初動を迅速化し、集団下校や交通規制の判断を最適化する。</p>
      ...
      <h2>島牧村におけるハンター襲撃事案の戦術的分析</h2>
      <p>2026年4月26日に発生し、5月1日にその凄惨な詳細が公開された島牧村の事案は、プロのハンターであっても防ぎきれないヒグマの圧倒的な攻撃力を示した 4。</p>
      <p>* 事案の経緯: 69歳のベテランハンターが、春期管理捕獲の一環として山林に入った際、手負いのヒグマに襲撃された。同行していた仲間の証言によれば、当該個体は数発の命中弾を受けながらも、その衝撃を無視して突進を続けた 4。</p>
      <p>* 個体の特異性: 駆除された個体は体重280キロのオスであった。特筆すべきは、通常であれば銃声や仲間の発砲に対して逃避行動をとるはずのヒグマが、逆に人間を標的として馬乗りになり、顔や頭部を徹底的に攻撃した点である 5。</p>
      <p>* 示唆されるリスク: 現場のハンターが「あんなにしぶといクマは初めて見た」と語るように、個体の生命力と対人攻撃性の強まりは、今後の「春グマ駆除」の継続を困難にする要因となり得る 5。</p>
      <h2>苫前町における330キロ級超巨大個体の出現</h2>
      <p>島牧村の個体を上回る脅威として報じられたのが、苫前町で捕獲された330キロ、体長2.2メートルのヒグマである 6。冬眠明け直後の個体がこれほどの重量を維持していることは、生態学的に極めて異常である。</p>
      <p>1. 栄養蓄積の背景: 専門家の分析では、昨秋のデントコーン（飼料用トウモロコシ）などの農作物を大量に摂取したことで、冬眠中も筋肉量と脂肪を維持できた可能性が高いとされる 6。</p>
      <p>2. 季節外れの活動性: 通常、春のヒグマは体力を温存しながら活動するが、この巨大個体はフェンスを破壊しようとするなどの旺盛な活動力を見せており、人里近くでの遭遇時の回避が極めて困難であることを裏付けている 6。</p>
      <h2>道内各地の生活圏における目撃と教育機関への影響</h2>
      <p>5月1日には、道北の猿払村や稚内市においても、ヒグマが人々の日常生活のすぐそばにまで迫っている実態が報告された。</p>
      <p>発生地点</p>
      <p>出没の具体的状況</p>
      <p>社会的影響・対応</p>
      <h3>猿払村 鬼志別</h3>
      <p>鬼志別小学校からわずか100メートル、住宅から10メートルの距離を歩行 7。</p>
      <p>学校周辺の緊張感が高まり、警察による厳重なパトロールが実施された 7。</p>
      <h3>稚内市 樺岡</h3>
      <p>11時50分頃、道路を横断するヒグマを運転手が目撃 7。</p>
      <p>幹線道路上での遭遇が増加しており、物流や観光への潜在的な脅威となっている 7。</p>
      <h3>釧路市 温根内</h3>
      <p>木道の一部通行止めが解除されたものの、依然として警戒が続く 8。</p>
      <p>観光資源である湿原などでの安全確保が課題となっている。</p>
      ...
      <p>* 発令のトリガー: 4月24日から30日までの1週間で、市街地における目撃件数が11件に達したことである 9。これは県が定めた「1週間で10件以上」という警報発令基準を突破した結果である。</p>
      <p>* 異常な出没数: 2026年の累計目撃件数は4月26日時点で86件に上り、過去10年の同時期と比較して「最多」の数値を記録している 10。</p>
      <p>* 具体的な出没地点: 5月1日当日も酒田市で目撃があり、前日には山辺町や金山町でも確認されている 10。</p>
      ...
      <h2>岩手県・盛岡市：住宅地と商業施設への「浸透」</h2>
      <p>岩手県内、特に県都・盛岡市では、5月1日の一日だけで都市機能の深部にまで熊が侵入した。</p>
      <p>時刻</p>
      <p>場所</p>
      <p>状況と個体の行動</p>
      <p>10:50</p>
      <h3>盛岡市下田（ファミマ渋民店付近）</h3>
      <p>子グマ1頭が歩行。駅方向へ立ち去り 12。コンビニという日常空間への出現。</p>
      <p>13:50</p>
      <h3>盛岡市月が丘（盛岡少年院東側）</h3>
      <p>通行人が徘徊する個体を目撃。立ち去り方向不明 13。</p>
      <p>18:37</p>
      <h3>盛岡市門（門字須摩付近）</h3>
      <p>住宅敷地内の小屋前でリンゴ箱を倒して荒らす成獣 13。</p>
      <p>夕方</p>
      <h3>洋野町戸類家</h3>
      <p>国道45号沿いでの目撃 13。</p>
      ...
      <h2>秋田県・宮城県：教育現場への直接的な脅威</h2>
      <p>秋田県と宮城県においても、5月1日は子供たちの安全が脅かされる事態となった。</p>
      <p>* 秋田県秋田市: 午前7時前、河辺地区の住宅街で体長1メートルの熊が出没 17。これを受け、河辺中学校は保護者の付き添いによる下校を決定した。また、横手市や能代市、鹿角市でも、民家からわずか数メートルの距離での目撃が相次いでいる 17。</p>
      <p>* 宮城県仙台市: 泉区での車両衝突事案（1.5メートル個体）や、富谷市での公園内3頭目撃情報を受け、小学校付近での警戒が最大化された 19。仙台市ではAIカメラの導入検討や柿の木の伐採など、インフラ面での防御策を急いでいる 19。</p>
      ...
      <p>* 社会的混乱: 近くの田中小学校は即座に臨時休校となり、滑川高校の伝統行事である「日本海開き」は延期を余儀なくされた 3。住民は「今までカモシカなどは川沿いに来たが、クマはあり得ないと思っていた」と証言しており、地理的な障壁（川、海、市街地）がもはや熊の移動を制限できていないことが判明した 3。</p>
      <p>* 構造要因: 川沿いの植生が、熊にとって隠蔽性の高い移動経路（グリーンコリドー）として機能しており、国交省の樹木伐採方針の正当性を証明する形となった。</p>
      <h2>長野県における対照的な二事例：原村と箕輪町</h2>
      <p>長野県からは、5月1日に「被害」と「成功」の対照的な報告が寄せられた。</p>
      <p>1. 原村の事例（レストラン侵入）: 4月30日に発生し1日に詳報された事案では、ペンションが並ぶ観光エリアのレストラン「ペチカ」に熊が侵入した 20。店主と至近距離で鉢合わせした体長1メートルの個体は、ドアに足跡を残し、ハチの巣箱を破壊して捕食していた 20。これは、熊が人間による「経済活動の場」を餌場として完全に学習していることを示す。</p>
      <p>2. 箕輪町の事例（ゾーニングの成功）: 対照的に箕輪町では、2026年度の目撃情報がゼロであり、人身被害も2年間発生していない 23。これは、徹底した「ゾーニング効果（クマの生息域と人里を分ける緩衝帯の整備）」によるものとされ、適切な環境管理がいかに有効であるかを裏付けている 20。</p>
      <h3>新潟県・静岡県の動向</h3>
      ...
      <h3>第1次変容（食性変化）</h3>
      <p>農作物、廃棄物、飼料への依存。</p>
      <p>苫前町の330kg個体（農作物摂取による巨大化） 6。</p>
      <h3>第2次変容（空間認知）</h3>
      <p>市街地、商業施設、住宅敷地への常態的侵入。</p>
      <p>盛岡市門のリンゴ箱破壊、原村レストラン侵入 15。</p>
      <h3>第3次変容（対人攻撃）</h3>
      <p>人間を捕食対象、あるいは排除すべきライバルと認識。</p>
      <p>島牧村のハンター襲撃（発砲に怯まず逆襲） 5。</p>
      ...
      <p>1. 物理的遮断（ゾーニング）の再構築: 箕輪町の成功事例に学び、市街地と山林の間に草刈りや伐採による「空白地帯」を設ける予算を全国的に拡充すべきである 2。特に河川敷の管理は急務である。</p>
      <p>2. 情報提供の質的転換: 山形県が示した「1週間で10件」といった数値目標に基づく警報発令は、住民の危機意識を喚起する上で有効である 9。他県においても、主観的な「注意報」から客観的な「数値基準による警報」へと移行し、集団下校や休校判断を自動化するプロトコルが必要である。</p>
      <p>3. 専門的捕獲体制の維持と強化: 島牧村の事例が示すように、ハンターの高齢化と熊の強大化は、民間ボランティアに近い体制での駆除が限界に達していることを示している 5。公的な「鳥獣対策専門官」の育成や、最新の銃器・防具、ドローンによる監視システムの導入を急ぐべきである。</p>
      <p>4. 都市部における行動指針の徹底: 専門家が指摘するように、市街地に出没する熊に対しては「音を出して追い払う」よりも「建物に逃げ込む」ことが重要である 11。ゴミ出しの管理、不要な果樹（柿やリンゴ）の伐採など、誘引物の徹底除去を都市機能の一部として組み込む必要がある 19。</p>
