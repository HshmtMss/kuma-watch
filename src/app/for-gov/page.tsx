...
const AUDIENCES = [
  ...
  },
  {
    who: "訪日外国人",
    how: "英語ページ",
    body: "高尾山・富士山・上高地・日光・知床など、全国 405 か所の英語ページを公開しています。日本語の公式ページだけでは届かない層に伝わります。",
  },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: "登山口・観光地ごとのページから地域のページへ辿れる構造にしており、「○○市 クマ」と検索した方が御自治体の情報に行き着きます。訪日外国人には、高尾山・富士山・上高地・日光・知床をはじめ全国 405 か所の英語ページで伝えます。",
  },
  {
    q: "当市の注意喚起の文章も載りますか？",
