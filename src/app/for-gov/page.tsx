...
const META_DESC =
  "御地域のクマ出没情報と安全に関する情報を、住民のスマホ・観光客の検索結果・訪日外国人向けの英語ページまで届けます。受け手は何もしなくても情報が届く配信基盤。御自治体のご対応は情報を出すだけ。まず 3 ヶ月無料。";
...
const FAQ = [
  ...
  },
  {
    ...
    a: "できます。AI カメラ・防犯カメラ・既存の通報システム・住民からの投稿など、どんな手段で把握された情報であっても、住民・観光客へ届けるためのハブとして機能します。既存の仕組みを置き換えるものではなく、その情報が「見に来ない人にも届く」状態を足すものとお考えください。",
  },
  {
