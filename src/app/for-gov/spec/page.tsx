      ...
      <article className="mx-auto max-w-4xl px-6 py-8 text-stone-800 print:max-w-none print:px-10 print:py-6 print:text-[11pt]">
        ...
        <section className="mt-6 rounded-lg border-2 border-amber-200 bg-amber-50 p-4 print:border print:bg-amber-50">
          ...
          <ul className="mt-2 space-y-1 text-sm leading-relaxed text-stone-800 print:text-[10pt]">
            <li>
              <strong>提供価値：</strong>
              貴自治体の公式情報を、住民・観光客・登山者に届ける Web サービス。連携後は「○○市 クマ」検索で表示される自治体専用ページに、公式情報の要約と公式ページへのリンクが組み込まれます。
            </li>
            <li>
              <strong>自治体側のご対応：</strong>
              新しい運用は不要。公式サイトをこれまで通り運用いただくだけで自動取り込みします。公式ページが未整備・PDF 運用・紙運用などのケースも、報道・住民投稿・隣接自治体や県の発表で補完するなど状況に応じて対応します。
            </li>
            <li>
              <strong>費用：</strong>
        ...
        <section className="mt-6 print:break-inside-avoid">
          ...
          <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <Item
              title="② 自治体公式情報の要約表示"
              body="貴自治体公式サイトの出没情報（件数・最新日・地区別・コメント等）を住民が読みやすい形に整理。連携が深まるほど、このページの中身が拡充されていきます。"
            />
            <Item
              title="③ 公式ページへのリンク・送客"
            ...
            />
            <Item
              title="⑤ 公式ページ未整備時の補完対応"
              body="公式ページが整備されていない自治体さまも、報道・住民投稿・隣接自治体や県の発表で補完するなど、状況に応じて対応します。後日、公式ページを整備された際は自動でそちらを一次出典に切り替えます。"
            />
            <Item
              title="⑥ 獣医師による監修"
        ...
        <section className="mt-6 print:break-inside-avoid">
          ...
          <div className="mt-2 space-y-2.5">
            ...
            <FAQ
              ...
              a="新しい運用は不要です。現状の公式サイトをそのまま運用いただくだけで KumaWatch 側が自動取り込みします。専用 API や CSV エクスポートのご準備も不要です。公式ページが未整備・PDF 運用・紙運用などのケースも、報道・住民投稿・隣接自治体や県の発表で補完するなど状況に応じて対応しますので、貴自治体側の作業は発生しません。"
            />
            <FAQ
