...
export const metadata: Metadata = {
  title: "サービス仕様書｜自治体連携",
  description:
    "KumaWatch（くまウォッチ）の自治体向け詳細仕様書。御自治体が公式ページで発表したクマ出没情報を、登録した住民・観光客の通知へ自動でお届け。まず 3 ヶ月無料でお試し。機能・導入フロー・技術仕様・運営体制・FAQ をまとめた庁内稟議用資料。",
      ...
      <article className="mx-auto max-w-4xl px-6 py-8 text-stone-800 print:max-w-none print:px-10 print:py-6 print:text-[11pt]">
        ...
        <section className="mt-6 rounded-lg border-2 border-amber-200 bg-amber-50 p-4 print:border print:bg-amber-50">
          ...
          <ul className="mt-2 space-y-1 text-sm leading-relaxed text-stone-800 print:text-[10pt]">
            <li>
              <strong>提供価値：</strong>
              御自治体が公式ページで発表したクマ出没情報を、登録した住民・観光客の通知へ自動でお届けするサービス。届けるのは御自治体の一次情報で、住民・観光客は公式ページへ誘導されます。
            </li>
            <li>
        ...
        <section className="mt-6 print:break-inside-avoid">
          ...
          <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <Item
              ...
              body="御自治体の公式クマ情報ページの更新を自動で検知し、登録した住民・観光客の通知（LINE・プッシュ通知）へお届けします。発表を見に来ない住民・観光客にも、公式情報が速く届きます。"
            />
            <Item
              title="③ 公式ページへのリンク・送客"
